...
const Home = () => {
  ...
  <div className="text-center mb-6"> {/* Reduced margin-bottom further */}
    <h1 className="text-3xl font-bold text-white">Projects</h1>
  </div>

  {/* Web Development Projects Section */}
  <div className="mb-4"> {/* Further reduced margin-bottom */}
...
<div className="bg-[#0E0526] py-16 px-10" data-aos="slide-up" data-aos-duration="9000"> {/* Reduced padding-top */}
  <div id="experience">
    <Experience />
  </div>
</div>
