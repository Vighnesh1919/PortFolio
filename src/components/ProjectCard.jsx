...
const ProjectCard = ({ title, description, imgSrc, liveDemo, githubLink, technologies }) => {
  return (
    <div
      className="border hover:-translate-y-2 hover:shadow-lg hover:shadow-gray-300 dark:border-gray-600 dark:hover:shadow-blue-800 group/card transition duration-300 border-gray-400 shadow-lg h-[30rem] w-96 sm:w-[28rem] rounded-xl flex flex-col justify-around p-3 bg-black"
      data-aos="fade-up"
    >
